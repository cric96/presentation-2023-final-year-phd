...
\begin{multicols}{3}
	\begin{figure}
		\large{Many \textbf{networked} agents}\\[0.1cm]
	...
	\end{figure}
	\begin{figure}
		\large{Collective intellingece}\\[0.1cm]
...
\begin{frame}{Contribution}
  \begin{alertblock}{Thesis goal}
    Finds a \emph{systematic} methodology to \bold{synthesize} and \bold{deploy} \emph{self-organising} behaviours of predictable outcomes for CPSW
  \end{alertblock}
\end{frame}
